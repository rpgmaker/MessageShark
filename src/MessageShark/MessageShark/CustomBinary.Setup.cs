...
namespace MessageShark
{
	public static partial class CustomBinary
	{
		...
		static readonly ConcurrentDictionary<Type, IEnumerable<FieldInfo>> TypeFields = new ConcurrentDictionary<Type, IEnumerable<FieldInfo>>();
		...
		static readonly ConcurrentDictionary<MemberInfo, Func<object, MemberInfo, object>> GetMemberValues = new ConcurrentDictionary<MemberInfo, Func<object, MemberInfo, object>>();
		static readonly ConcurrentDictionary<FieldInfo, Delegate> SetMemberValues = new ConcurrentDictionary<FieldInfo, Delegate>();
		
		const BindingFlags FieldBinding = BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic;
		...
		static readonly Type MemberInfoType = typeof(MemberInfo);
		...
		static MethodInfo GetDynamicMemberValueMethod =
			CustomBinaryType.GetMethod("GetDynamicMemberValue", MethodBinding);
		static MethodInfo SetDynamicMemberValueMethod =
			CustomBinaryType.GetMethod("SetDynamicMemberValue", MethodBinding);
